...
# %% TASK 4, 5, 6 (LOAD WHICH IS A BATTERY AT BUS 94 and (Load which makes all the nodes between yellow and light blue)

#Negative load which balances the system and injects 
pp.create_load(net,bus=94,p_mw=-12,q_mvar=-0.2)
